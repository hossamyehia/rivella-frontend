...
import { useGlobalFilter } from '../../../shared/context/globalFilter.context';
...
const Filter = () => {
  ...
  const _ChaletService = new PublicChaletService(axiosInstance);
  const { filters, updateFilters } = useGlobalFilter();
