...
const AdminBookings = () => {
  ...
  const fetchBookings = async () => {
    ...
    try {
      ...
      if (dateFilter.startDate) params.startDate = dateFilter.startDate.toISOString().split('T')[0];
      if (dateFilter.endDate) params.endDate = dateFilter.endDate.toISOString().split('T')[0];
  ...
  const handleDateFilterChange = (type) => (newDate) => {
    setDateFilter({
      ...dateFilter,
      [type]: newDate
    });
